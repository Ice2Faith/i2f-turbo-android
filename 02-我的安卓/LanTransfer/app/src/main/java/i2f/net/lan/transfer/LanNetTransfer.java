 ...
 * @desc
 */
public class LanNetTransfer {
    public static final Integer SERVER_PORT = 63321;
            ...
            try{
                ...
                while(true){
                    ...
                    if(resp.isTextPlain()){
                        ...
                        System.err.println("server "+sock.getInetAddress().getHostAddress()+":"+str);
                        if("exit".equals(str)){
                            sock.close();
        ...
        protected void sockProcess(int index, Socket sock) {
            ...
            try{
                ...
                while(true) {
                    ...
                    if(resp.isTextPlain()){
                        String str=resp.getAsString();
                        System.err.println("client "+sock.getInetAddress().getHostAddress()+":"+str);
                        if("exit".equals(str)){
                            System.err.println("client exit:"+sock.getInetAddress().getHostAddress());
                            NetTransfer.sendString("exit",os);
                            sock.close();
                            break;
                        }
                        if("hello".equals(str)){
                            System.err.println("client hello:"+sock.getInetAddress().getHostAddress());
                        ...
                        System.err.println("save client file:"+fileName+"\n\t-> "+file.getAbsolutePath());
